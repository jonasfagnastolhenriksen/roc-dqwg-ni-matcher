...
def run_matcher(input_path: str, output_path: str) -> None:
    df = pd.read_csv(input_path)

    # Eksempel-matching: legg til kolonne 'matched' hvis personnummer slutter på 0
    df["matched"] = df["national_id"].astype(str).str.endswith("0")
